...
class DataModule(pl.LightningDataModule):
    def __init__(
        ...
        if train_years is not None:
            ...
            self.datasets["train"] = BatchTruth(
                df_truth,
        ...
        if val_years is not None:
            ...
            self.datasets["valid"] = BatchTruth(
                df_truth,
                batch_size=[xbatch_size[0], 300, 300],
    ...
    def dataloader(self, split):
        ...
        if split == "train":
            ...
            return DataLoader(
                ...
                pin_memory=True,
                num_workers=0,
                sampler=self.datasets[split].sampler,
                drop_last=True,
            )
        else:
            return DataLoader(
